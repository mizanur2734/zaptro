        ...
        {data?.slice(0, 7)?.map((item, index) => {
          return (
            <div className="bg-gradient-to-r from-[#0f0c29] via-[#302b63] to-[#24243e] -z-10">
              <div className="flex gap-10 justify-center h-[550px] items-center px-4">
                <div className="space-y-6">
                  ...
                  <button
                    className="bg-gradient-to-r from-red-500 to-purple-500 text-white px-3 py-3
                ...
                <div>
                  <img
                    src={item.image}
                    alt={item.title}
                    className="rounded-full w-[400px] hover:scale-105 transition-all shadow-md shadow-red-400"
                  />
                </div>
              </div>
            </div>
